...
<head>
	...
	<title>Green Source | PBWL PROJECT</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/gslogo2.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/gslogo2.png" class="brand">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/Golongan">
						<img class="icon" src="<?php echo AST; ?>/img/cate.png" alt=""> Golongan
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/customer.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023 - <?php echo date('Y'); ?>. Designed by Syafhira Ananda
		</footer>
	</main>
